<template>
    <div class="pa-5">
        <base-card class=" rounded darkgrey"><h3 class=" pa-3 white--text">Holdings List</h3>
             <v-row>
                <v-col cols="12">
                     <v-data-table
    :headers="HoldingsHeaders"
    :items="HoldingsData.value"
    :items-per-page="5"
    class="theme--dark">
