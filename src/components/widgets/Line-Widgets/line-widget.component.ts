...
@Component
export default class LineWidget extends Vue {
    public data = [
    ...
    public countries = ['Finland', 'France', 'Germany', 'Iceland', 'Norway', 'Poland', 'Russia', 'United Kingdom'];
    public TransactionSrv = new TransactionService();
    public datasetWithFilters: echarts.DatasetComponentOption[] = [];
    public seriesList: echarts.SeriesOption[] = [];
    ...
    public getGraphData() {
        ...
        this.TransactionSrv.Holdings.subscribe((res) => console.log(res))
